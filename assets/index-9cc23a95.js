 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lk(e){An(new Xt("platform-logger",t=>new EC(t),"PRIVATE")),An(new Xt("heartbeat",t=>new ok(t),"PRIVATE")),Mt(Ku,Jh,e),Mt(Ku,Jh,"esm2017"),Mt("fire-js","")}lk("");var uk="firebase",ck="10.1.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cy="installations",rb="installations-internal",ib=e=>{const t=e.getProvider("app").getImmediate(),n=nb(t),r=bo(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},ob=e=>{const t=e.getProvider("app").getImmediate(),n=bo(t,Cy).getImmediate();return{getId:()=>Zk(n),getToken:i=>eb(n,i)}};function sb(){An(new Xt(Cy,ib,"PUBLIC")),An(new Xt(rb,ob,"PRIVATE"))}sb();Mt(sy,Nf);Mt(sy,Nf,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wb{constructor(){this.cache_={},this.isInMemoryStorage=!0}set(t,n){n==null?delete this.cache_[t]:this.cache_[t]=n}get(t){return nn(this.cache_,t)?this.cache_[t]:null}remove(t){delete this.cache_[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iT{constructor(){this.counters_={}}incrementCounter(t,n=1){nn(this.counters_,t)||(this.counters_[t]=0),this.counters_[t]+=n}get(){return PE(this.counters_)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`,`
FIREBASE: `))}restoreState_(){this.tryAuth(),this.tryAppCheck();for(const t of this.listens.values())for(const n of t.values())this.sendListen_(n);for(let t=0;t<this.outstandingPuts_.length;t++)this.outstandingPuts_[t]&&this.sendPut_(t);for(;this.onDisconnectRequestQueue_.length;){const t=this.onDisconnectRequestQueue_.shift();this.sendOnDisconnect_(t.action,t.pathString,t.data,t.onComplete)}for(let t=0;t<this.outstandingGets_.length;t++)this.outstandingGets_[t]&&this.sendGet_(t)}sendConnectStats_(){const t={};let n="js";t["sdk."+n+"."+xy.replace(/\./g,"-")]=1,Gv()?t["framework.cordova"]=1:WE()&&(t["framework.reactnative"]=1),this.reportStats(t)}shouldReconnect_(){const t=ta.getInstance().currentlyOnline();return Yh(this.interruptReasons_)&&t}}Wt.nextPersistentConnectionId_=0;Wt.nextConnectionId_=0;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let rc;function jT(e){rc=e}const i_=function(e){return typeof e=="number"?"number:"+Ry(e):"string:"+e},o_=function(e){if(e.isLeafNode()){const t=e.val();N(typeof t=="string"||typeof t=="number"||typeof t=="object"&&nn(t,".sv"),"Priority must be a string or number.")}else N(e===rc||e.isEmpty(),"priority of unexpected type.");N(e===rc||e.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pp=10*1e3,nI=30*1e3,rI=5*60*1e3;class iI{constructor(t,n){this.server_=n,this.statsToReport_={},this.statsListener_=new tI(t);const r=Pp+(nI-Pp)*Math.random();Ui(this.reportStats_.bind(this),Math.floor(r))}reportStats_(){const t=this.statsListener_.get(),n={};let r=!1;mt(t,(i,o)=>{o>0&&nn(this.statsToReport_,i)&&(n[i]=o,r=!0)}),r&&this.server_.reportStats(n),Ui(this.reportStats_.bind(this),Math.floor(Math.random()*2*rI))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oa{constructor(t,n,r){this.path=t,this.affectedTree=n,this.revert=r,this.type=Pt.ACK_USER_WRITE,this.source=u_()}operationForChild(t){if(Y(this.path)){if(this.affectedTree.value!=null)return N(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const n=this.affectedTree.subtree(new fe(t));return new oa(te(),n,this.revert)}}else return N(W(this.path)===t,"operationForChild called for unrelated child."),new oa(ae(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ur{constructor(t,n,r){this.source=t,this.path=n,this.snap=r,this.type=Pt.OVERWRITE}operationForChild(t){return Y(this.path)?new ur(this.source,te(),this.snap.getImmediateChild(t)):new ur(this.source,ae(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mo{constructor(t,n,r){this.source=t,this.path=n,this.children=r,this.type=Pt.MERGE}operationForChild(t){if(Y(this.path)){const n=this.children.subtree(new fe(t));return n.isEmpty()?null:n.value?new ur(this.source,te(),n.value):new mo(this.source,te(),n)}else return N(W(this.path)===t,"Can't get a merge for a child not on the path of the operation"),new mo(this.source,ae(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qI{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function j_(e,t){let n=null;for(let r=0;r<t.length;r++){const i=t[r],o=i.getPath();n!==null&&!t_(o,n.path)&&(e.eventLists_.push(n),n=null),n===null&&(n={events:[],path:o}),n.events.push(i)}n&&e.eventLists_.push(n)}function Zt(e,t,n){j_(e,n),XI(e,r=>Et(r,t)||Et(t,r))}function XI(e,t){e.recursionDepth_++;let n=!0;for(let r=0;r<e.eventLists_.length;r++){const i=e.eventLists_[r];if(i){const o=i.path;t(o)?(JI(e.eventLists_[r]),e.eventLists_[r]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function JI(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(n!==null){e.events[t]=null;const r=n.getEventRunner();Xn&&je("event: "+n.toString()),li(r)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gx="FIREBASE_DATABASE_EMULATOR_HOST",hc={};let vx=!1;function yx(e,t,n,r){e.repoInfo_=new Wy(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams,!0),r&&(e.authTokenProvider_=r)}function _x(e,t,n,r,i){let o=r||e.options.databaseURL;o===void 0&&(e.options.projectId||Jt("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),je("Using default host for project ",e.options.projectId),o=`${e.options.projectId}-default-rtdb.firebaseio.com`);let s=Yp(o,i),a=s.repoInfo,l,u;typeof process<"u"&&process.env&&(u=process.env[gx]),u?(l=!0,o=`http://${u}?ns=${a.namespace}`,s=Yp(o,i),a=s.repoInfo):l=!s.repoInfo.secure;const c=i&&l?new Wr(Wr.OWNER):new nT(e.name,e.options,t);QI("Invalid Firebase Database URL",s),Y(s.path)||Jt("Database URL must point to the root of a Firebase Database (not including a child path).");const f=Sx(a,e,c,new tT(e.name,n));return new Ex(f,e)}function wx(e,t){const n=hc[t];(!n||n[e.key]!==e)&&Jt(`Database ${t}(${e.repoInfo_}) has already been deleted.`),sx(e),delete n[e.key]}function Sx(e,t,n,r){let i=hc[t.name];i||(i={},hc[t.name]=i);let o=i[e.toURLString()];return o&&Jt("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."),o=new tx(e,vx,n,r),i[e.toURLString()]=o,o}class Ex{constructor(t,n){this._repoInternal=t,this.app=n,this.type="database",this._instanceStarted=!1}get _repo(){return this._instanceStarted||(nx(this._repoInternal,this.app.options.appId,this.app.options.databaseAuthVariableOverride),this._instanceStarted=!0),this._repoInternal}get _root(){return this._rootInternal||(this._rootInternal=new mr(this._repo,te())),this._rootInternal}_delete(){return this._rootInternal!==null&&(wx(this._repo,this.app.name),this._repoInternal=null,this._rootInternal=null),Promise.resolve()}_checkNotDeleted(t){this._rootInternal===null&&Jt("Cannot call "+t+" on a deleted database.")}}function Cx(e=ty(),t){const n=bo(e,"database").getImmediate({identifier:t});if(!n._instanceStarted){const r=zE("database");r&&kx(n,...r)}return n}function kx(e,t,n,r={}){e=Mn(e),e._checkNotDeleted("useEmulator"),e._instanceStarted&&Jt("Cannot call useEmulator() after instance has already been initialized.");const i=e._repoInternal;let o;if(i.repoInfo_.nodeAdmin)r.mockUserToken&&Jt('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),o=new Wr(Wr.OWNER);else if(r.mockUserToken){const s=typeof r.mockUserToken=="string"?r.mockUserToken:UE(r.mockUserToken,e.app.options.projectId);o=new Wr(s)}yx(i,t,n,o)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bx(e){$b(ZC),An(new Xt("database",(t,{instanceIdentifier:n})=>{const r=t.getProvider("app").getImmediate(),i=t.getProvider("auth-internal"),o=t.getProvider("app-check-internal");return _x(r,i,o,n)},"PUBLIC").setMultipleInstances(!0)),Mt(hp,pp,e),Mt(hp,pp,"esm2017")}Wt.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)};Wt.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};bx();aE.add(uE,cE);const Tx={apiKey:"AIzaSyBYOLsLlqNQTFgwWO1fyHUTgTHQ4JRgA-A",authDomain:"wmcyn-online-web.firebaseapp.com",projectId:"wmcyn-online-web",storageBucket:"wmcyn-online-web.appspot.com",messagingSenderId:"552241957320",appId:"1:552241957320:web:c32590238a5e7ec06858fd",measurementId:"G-KGVGX3LN7P"},G_=ey(Tx);Fb(G_);const Ix=Cx(G_);function xx(e){const t=px(Ix,"emailList"),n=mx(t);Y_(n,{email:e})}const Nx=()=>{const[e,t]=jt.useState(""),[n,r]=jt.useState(!1),[i,o]=jt.useState(!0),[s,a]=jt.useState(""),[l,u]=jt.useState(!1),c=w=>{t(w.target.value)},f=()=>{i&&o(!1)},d=w=>{a(w.target.value)},h=w=>{w.preventDefault(),xx(e),r(!0),console.log("Email submitted:",e),console.log("Password submitted:",s)},m=()=>{const w=document.getElementById("friendsAndFamilySection"),g=document.getElementById("aboutSection"),v=(l?w:g).offsetTop-100;window.scrollTo({top:v,behavior:"smooth"}),u(!l)},y=()=>{window.scrollTo({top:0,behavior:"smooth"}),u(!1)};return ee.jsxs("div",{children:[ee.jsxs("div",{className:"container",children:[ee.jsx("img",{src:NE,alt:"Logo",className:"logo"}),n?ee.jsxs(ee.Fragment,{children:[ee.jsx("h1",{className:"typewriter",children:ee.jsx(yh,{options:{strings:["WMCYN WELCOMES YOU"],autoStart:!0,loop:!0}})}),ee.jsx("p",{children:"Subscribed."})]}):ee.jsxs(ee.Fragment,{children:[ee.jsx("h1",{className:"typewriter",children:ee.jsx(yh,{options:{strings:["YOU'RE EARLY...","SIGN UP FOR OUR NEWSLETTER"],autoStart:!0,loop:!0}})}),ee.jsxs("form",{onSubmit:h,children:[ee.jsx("input",{type:"email",placeholder:i?"Enter your email":"",value:e,onChange:c,onClick:f,className:"input-field"}),ee.jsx("button",{type:"submit",className:"submit-button",children:"Subscribe"})]})]})]}),ee.jsxs("div",{id:"friendsAndFamilySection",className:"container friends-and-family-section",children:[ee.jsx("h2",{className:"section-heading",children:"FRIENDS AND FAMILY SHOP"}),ee.jsxs("form",{onSubmit:h,children:[ee.jsx("input",{type:"password",placeholder:"Enter password",value:s,onChange:d,className:"input-field"}),ee.jsx("button",{type:"submit",className:"submit-button",children:"Enter"})]})]}),ee.jsxs("div",{className:"container",id:"aboutSection",children:[ee.jsx("h2",{className:"section-heading",children:"ABOUT WMCYN"}),ee.jsx("p",{className:"section-text",children:"future forward start-up built on the advancement of modern technology intertwined with the basics of everyday lifestyle"})]}),ee.jsx("div",{className:"scroll-button-container",children:ee.jsx("button",{className:`scroll-button ${l?"up":"down"}`,onClick:l?y:m,children:ee.jsx(ko,{icon:l?"arrow-up":"arrow-down"})})})]})};jl.createRoot(document.getElementById("root")).render(ee.jsx(_c.StrictMode,{children:ee.jsx(Nx,{})}));
