 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bt{constructor(t){this.writeTree_=t}static empty(){return new bt(new se(null))}}function Bi(e,t,n){if(Y(t))return new bt(new se(n));{const r=e.writeTree_.findRootMostValueAndPath(t);if(r!=null){const i=r.path;let o=r.value;const s=ft(i,t);return o=o.updateChild(s,n),new bt(e.writeTree_.set(i,o))}else{const i=new se(n),o=e.writeTree_.setTree(t,i);return new bt(o)}}}function Rp(e,t,n){let r=e;return mt(n,(i,o)=>{r=Bi(r,Ce(t,i),o)}),r}function Dp(e,t){if(Y(t))return bt.empty();{const n=e.writeTree_.setTree(t,new se(null));return new bt(n)}}function sc(e,t){return pr(e,t)!=null}function pr(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return n!=null?e.writeTree_.get(n.path).getChild(ft(n.path,t)):null}function Mp(e){const t=[],n=e.writeTree_.value;return n!=null?n.isLeafNode()||n.forEachChild(ze,(r,i)=>{t.push(new K(r,i))}):e.writeTree_.children.inorderTraversal((r,i)=>{i.value!=null&&t.push(new K(r,i.value))}),t}function kn(e,t){if(Y(t))return e;{const n=pr(e,t);return n!=null?new bt(new se(n)):new bt(e.writeTree_.subtree(t))}}function ac(e){return e.writeTree_.isEmpty()}function ti(e,t){return p_(te(),e.writeTree_,t)}function p_(e,t,n){if(t.value!=null)return n.updateChild(e,t.value);{let r=null;return t.children.inorderTraversal((i,o)=>{i===".priority"?(N(o.value!==null,"Priority writes must always be leaf nodes"),r=o.value):n=p_(Ce(e,i),o,n)}),!n.getChild(e).isEmpty()&&r!==null&&(n=n.updateChild(Ce(e,".priority"),r)),n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class XI{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function j_(e,t){let n=null;for(let r=0;r<t.length;r++){const i=t[r],o=i.getPath();n!==null&&!t_(o,n.path)&&(e.eventLists_.push(n),n=null),n===null&&(n={events:[],path:o}),n.events.push(i)}n&&e.eventLists_.push(n)}function Zt(e,t,n){j_(e,n),JI(e,r=>Et(r,t)||Et(t,r))}function JI(e,t){e.recursionDepth_++;let n=!0;for(let r=0;r<e.eventLists_.length;r++){const i=e.eventLists_[r];if(i){const o=i.path;t(o)?(ZI(e.eventLists_[r]),e.eventLists_[r]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function ZI(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(n!==null){e.events[t]=null;const r=n.getEventRunner();Xn&&je("event: "+n.toString()),li(r)}}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tx(e){Bb(ek),An(new Xt("database",(t,{instanceIdentifier:n})=>{const r=t.getProvider("app").getImmediate(),i=t.getProvider("auth-internal"),o=t.getProvider("app-check-internal");return wx(r,i,o,n)},"PUBLIC").setMultipleInstances(!0)),Lt(hp,pp,e),Lt(hp,pp,"esm2017")}Wt.prototype.simpleListen=function(e,t){this.sendRequest("q",{p:e},t)};Wt.prototype.echo=function(e,t){this.sendRequest("echo",{d:e},t)};Tx();aE.add(uE,cE);const Ix={apiKey:"AIzaSyBYOLsLlqNQTFgwWO1fyHUTgTHQ4JRgA-A",authDomain:"wmcyn-online-web.firebaseapp.com",projectId:"wmcyn-online-web",storageBucket:"wmcyn-online-web.appspot.com",messagingSenderId:"552241957320",appId:"1:552241957320:web:c32590238a5e7ec06858fd",measurementId:"G-KGVGX3LN7P"},G_=ey(Ix);jb(G_);const xx=kx(G_);function Nx(e){const t=mx(xx,"emailList"),n=gx(t);Y_(n,{email:e})}const Ax=()=>{const[e,t]=At.useState(""),[n,r]=At.useState(!1),[i,o]=At.useState(!0),[s,a]=At.useState(""),[l,u]=At.useState(!1),c=w=>{t(w.target.value)},f=()=>{i&&o(!1)},d=w=>{a(w.target.value)},h=w=>{w.preventDefault(),Nx(e),r(!0),console.log("Email submitted:",e),console.log("Password submitted:",s)},m=()=>{const w=document.getElementById("friendsAndFamilySection"),g=document.getElementById("aboutSection"),v=(l?w:g).offsetTop-100;window.scrollTo({top:v,behavior:"smooth"}),u(!l)},y=()=>{window.scrollTo({top:0,behavior:"smooth"}),u(!1)};return At.useEffect(()=>{const w=()=>{window.innerHeight+window.scrollY>=document.body.offsetHeight?u(!0):window.scrollY===0&&u(!1)};return window.addEventListener("scroll",w),()=>{window.removeEventListener("scroll",w)}},[]),q.jsxs("div",{children:[q.jsxs("div",{className:"container",children:[q.jsx("img",{src:NE,alt:"Logo",className:"logo"}),n?q.jsxs(q.Fragment,{children:[q.jsx("h1",{className:"typewriter",children:q.jsx(yh,{options:{strings:["WMCYN WELCOMES YOU"],autoStart:!0,loop:!0}})}),q.jsx("p",{children:"Subscribed."})]}):q.jsxs(q.Fragment,{children:[q.jsx("h1",{className:"typewriter",children:q.jsx(yh,{options:{strings:["YOU'RE EARLY...","SIGN UP FOR OUR NEWSLETTER"],autoStart:!0,loop:!0}})}),q.jsxs("form",{onSubmit:h,children:[q.jsx("input",{type:"email",placeholder:i?"Enter your email":"",value:e,onChange:c,onClick:f,className:"input-field"}),q.jsx("button",{type:"submit",className:"submit-button",children:"Subscribe"})]})]})]}),q.jsxs("div",{id:"friendsAndFamilySection",className:"container friends-and-family-section",children:[q.jsx("h2",{className:"section-heading",children:"FRIENDS AND FAMILY SHOP"}),q.jsxs("form",{onSubmit:h,children:[q.jsx("input",{type:"password",placeholder:"Enter password",value:s,onChange:d,className:"input-field"}),q.jsx("button",{type:"submit",className:"submit-button",children:"Enter"})]})]}),q.jsxs("div",{className:"container",id:"aboutSection",children:[q.jsx("h2",{className:"section-heading",children:"ABOUT WMCYN"}),q.jsx("p",{className:"section-text",children:"future forward start-up built on the advancement of modern technology intertwined with the basics of everyday lifestyle"}),q.jsx("div",{className:"instagram-container",children:q.jsx("a",{href:"https://instagram.com/whatmorecouldyouneed",className:"instagram-link",children:q.jsx("img",{src:AE,alt:"Instagram",className:"instagram-logo"})})})]}),q.jsx("div",{className:"scroll-button-container",children:q.jsx("button",{className:`scroll-button ${l?"up":"down"}`,onClick:l?y:m,children:q.jsx(ko,{icon:l?"arrow-up":"arrow-down"})})})]})};jl.createRoot(document.getElementById("root")).render(q.jsx(_c.StrictMode,{children:q.jsx(Ax,{})}));
